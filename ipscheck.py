...
def VTscanner(valid_ips):
    while True:
        DoScan = input("Do you wish to proceed to scan IPs found? (Yes/No) ")
...
banner()
while True:
    choosePlatform = input(r"""Which service would you like to use for scanning IPs found? (Select the number of the desired service)
1 ---------------> VT
2 ---------------> AbuseIPDB
""")
